...
export default function App() {
  ...
  useEffect(() => {
    (async function () {
      ...
      console.log("networkId = ", DecentralizedInstagram);
      // const networkData = DecentralizedInstagram.networks[networkId];
      const decentralizedInstagram = new web3.eth.Contract(
        DecentralizedInstagram.abi,
        "0xE865dBa200B03977f20DE3b913453d2Dca75bCCd"
      );
  ...
  return dependencies.loaded ? (
    dependencies.account ? (
      <HomeWrapper
        ...
        decentralizedInstagram={dependencies.decentralizedInstagram}
      />
    ) : (
      <button onClick={connect} className="app-button app-button-primary">
        Connect
      </button>
    )
  ) : (
